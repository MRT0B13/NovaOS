...
**Local Development:** Falls back to `./data/pnl_tracker.json` if no `DATABASE_URL`.

See [POSTGRESQL_ARCHITECTURE.md](./POSTGRESQL_ARCHITECTURE.md) for full schema details.
