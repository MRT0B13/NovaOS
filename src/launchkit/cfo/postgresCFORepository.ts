...
export type PositionStrategy = 'polymarket' | 'hyperliquid' | 'kamino' | 'kamino_loop' | `kamino_${string}_loop` | 'kamino_multiply_vault' | 'orca_lp' | 'jito' | 'jupiter_swap' | 'evm_flash_arb';
