...
export type PositionStrategy = 'polymarket' | 'hyperliquid' | 'kamino' | 'kamino_loop' | 'kamino_jito_loop' | 'kamino_msol_loop' | 'kamino_bsol_loop' | 'kamino_multiply_vault' | 'orca_lp' | 'jito' | 'jupiter_swap' | 'evm_flash_arb';
